...
#include "Karen/Events/Event.h"

namespace Karen
{
  class KAREN_API KeyEvent : public Event
  {
  public:
  ...
  class KAREN_API KeyPressedEvent : public KeyEvent
  {
  public:
  ...
  class KAREN_API KeyReleasedEvent : public KeyEvent
  {
  public:
