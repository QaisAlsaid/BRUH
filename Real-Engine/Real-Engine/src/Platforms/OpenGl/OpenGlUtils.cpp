...
namespace Karen::OpenGlUtils
{
  ...
  GLenum toOpenGlFormat(FrameBuffer::TextureFormat fptf)
  {
    switch(fptf)
    {
      ...
      case FrameBuffer::TextureFormat::None: KAREN_CORE_ERROR("Unsupported"); return 0;
    }
    KAREN_CORE_ASSERT(false);
    return 0;
  }
  ...
  GLenum toOpenGlFormat(FrameBuffer::TextureInternalFormat i_fmt)
  {
    switch(i_fmt)
    {
      ...
      case FrameBuffer::TextureInternalFormat::None: KAREN_CORE_ERROR("Unsupported"); return 0;
    }
    KAREN_CORE_ASSERT(false);
    return 0;
  }
